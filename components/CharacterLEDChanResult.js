class CharacterLEDChanResult extends HTMLElement {
  constructor() {
    super();
  ...
  render() {
    return `
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="100%" viewBox="100 200 1280 1500" preserveAspectRatio="xMidYMid meet" data-app="Xyris" class="character">
        <defs>
        </defs>
...
customElements.define('character-ledchan-result', CharacterLEDChanResult);