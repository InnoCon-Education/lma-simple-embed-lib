class CharacterLEDGreenChan extends HTMLElement {
  constructor() {
    super();
  ...
  _importStyles() {
    ...
    const existingLink = document.querySelector('link[href*="character-ledgreenchan.css"]');
    if (!existingLink) {
      const link = document.createElement('link');
      link.rel = 'stylesheet';
      link.href = './components/character-ledgreenchan.css';
      document.head.appendChild(link);
    }
  }
  ...
  connectedCallback() {
    try {
      ...
      console.error('CharacterLEDGreenChan component render error:', error);
    }
  }
  ...
  render() {
    return `
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="100%" viewBox="0 0 1280 1500" preserveAspectRatio="xMidYMid meet" data-app="Xyris" class="character">
        <defs>
          <filter id="filter-pf8sv9AYHzBMrxHJ2CGvRv-${this._maskId}" x="-0.243" y="-0.118" width="1.307" height="1.254" color-interpolation-filters="sRGB">
            <feFlood flood-color="#fff" result="bg">
            </feFlood>
            <feBlend in="SourceGraphic" in2="bg">
            </feBlend>
          </filter>
          <filter id="filter-ufVoawNb87EvfJUs9Ac5Dn-${this._maskId}" x="0.009" y="0.097" width="0.845" height="0.807" color-interpolation-filters="sRGB">
            <feFlood flood-color="#fff" result="bg">
            </feFlood>
            <feBlend in="SourceGraphic" in2="bg">
            </feBlend>
        ...
        <g id="main-group" transform-origin="center" transform="" style="transform-box: fill-box;">
          ...
          <g id="body-container-group" transform-origin="center" transform="" style="transform-box: fill-box;">
            ...
            <g id="body-group" transform-origin="center" style="transform-box: fill-box;">
              <path d="M 955.734 1160.25 L 955.734 888.246 C 955.734 766.743 857.237 668.246 735.734 668.246 C 614.231 668.246 515.734 766.743 515.734 888.246 L 515.734 1160.25 L 483.734 1160.25 L 483.734 1224.25 L 987.734 1224.25 L 987.734 1160.25 L 955.734 1160.25 Z" fill="rgb(91, 191, 33)" transform="">
              </path>
          ...
          <g id="hat-mask-group" transform-origin="center" transform="" style="transform-box: fill-box;">
            <g mask="url(#${this._maskId2})" transform="">
              <g transform="">
                ...
                <mask id="${this._maskId3}" x="417.2951" y="522.7257" width="597.5797" height="680.4085" maskUnits="userSpaceOnUse">
                  <g filter="url(#filter-ufVoawNb87EvfJUs9Ac5Dn-${this._maskId})" transform="">
            ...
            <mask id="${this._maskId2}" x="417.2951" y="530.5127" width="397.8376" height="533.2228" maskUnits="userSpaceOnUse">
              <g filter="url(#filter-pf8sv9AYHzBMrxHJ2CGvRv-${this._maskId})" transform="">
...
customElements.define('character-ledgreenchan', CharacterLEDGreenChan);
